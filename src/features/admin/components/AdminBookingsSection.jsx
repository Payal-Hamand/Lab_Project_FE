              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="mt-3 bg-primary/10 rounded-lg p-3">
                    ...
                    <p title={item.labOwner?.labAddress} className="text-[10px] text-muted-foreground mt-0.5 truncate">
                  ...
                  <div className="mt-2 bg-accent rounded-lg p-3">
                    ...
                    <div className="flex justify-between items-center gap-3">
                      <h3 className="text-xs font-medium text-foreground flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-2">
                    <div className="bg-primary/10 rounded-lg p-2.5">
                      ...
                      <h3 className="text-xs font-medium text-foreground mt-0.5">{item.bookingDate}</h3>
                    </div>
                    <div className="bg-primary/10 rounded-lg p-2.5">
                      <p className="text-[10px] text-muted-foreground">Time</p>
                      <h3 className="text-xs font-medium text-foreground mt-0.5">{item.bookingTime}</h3>
                    </div>
                  </div>

                  <div className="mt-2 bg-primary/10 rounded-lg p-3 flex justify-between items-center">
