  ...
  return (
    ...
    <Navbar/>
      ...
      >
        ...
        >
          Checked Up connects you to accredited labs for booking, home sample
          collection, and reports — all in one place, without the phone
          calls, paperwork, or waiting rooms.
        </p>
      ...
      <section style={{ padding: "80px 24px", maxWidth: "980px", margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            <p style={{ fontSize: "15px", lineHeight: 1.75, color: "#475569", margin: "0 0 14px" }}>
              We kept running into the same problem: booking a simple blood
              test meant calling three labs, comparing prices with no clear
              menu, and then chasing a PDF over WhatsApp days later. Health
              data that matters was scattered across group chats and paper
              slips.
            </p>
            <p style={{ fontSize: "15px", lineHeight: 1.75, color: "#475569", margin: 0 }}>
              Checked Up puts booking, collection, payment, and your report
              history behind one login — backed by labs we vet ourselves,
              not just the ones that pay for placement.
            </p>
          </div>
          <div
            style={{
      ...
      <section style={{ padding: "72px 24px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "15px", color: "#64748B", margin: "0 0 28px" }}>
          Home collection is available in 40+ cities, with reports usually
          ready within a day.
        </p>
        <button
          style={{
