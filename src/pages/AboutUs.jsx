        ...
        >
          <div>
            ...
            <p style={{ fontSize: '15px', lineHeight: 1.75, color: '#475569', margin: '0 0 14px' }}>
              We kept running into the same problem: booking a simple blood test meant calling three
              labs, comparing prices with no clear menu, and then chasing a PDF over WhatsApp days
              later. Health data that matters was scattered across group chats and paper slips.
            </p>
            <p style={{ fontSize: '15px', lineHeight: 1.75, color: '#475569', margin: 0 }}>
              Checked Up puts booking, collection, payment, and your report history behind one login
              — backed by labs we vet ourselves, not just the ones that pay for placement.
            </p>
          </div>
          <div
            style={{
